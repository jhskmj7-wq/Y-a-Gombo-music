    ...
    >
      <div className="space-y-4 py-1 text-left">
        ...
        <div className="flex items-center gap-3">
          <div className="p-3 bg-[#D4AF37]/15 border border-[#D4AF37]/40 text-[#D4AF37] rounded-2xl shrink-0">
        ...
        <button
          onClick={onClose}
          className="w-full min-h-[50px] bg-[#D4AF37] text-black font-black text-xs uppercase tracking-wider rounded-2xl cursor-pointer hover:bg-[#e0c058] transition-all flex items-center justify-center gap-2 shadow-lg active:scale-98 touch-manipulation"
        >
