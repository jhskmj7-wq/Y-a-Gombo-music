  ...
  useEffect(() => {
    ...
    try {
      ...
      const unsubscribeMainPosts = onSnapshot(qPosts, (snapshot) => {
        ...
        console.warn("🔐 Posts sync limited or offline:", error.code, error.message);
      ...
      const unsubscribeSocialPosts = onSnapshot(qSocialPosts, (snapshot) => {
        ...
        console.warn("🔐 Social posts sync limited:", error.code, error.message);
      });
            ...
            <form onSubmit={async (e) => {
              ...
              <div>
                ...
                <select name="issueType" className="w-full bg-afri-bg border border-afri-border rounded-lg p-3 text-xs text-afri-text focus:border-afri-gold/50 focus:outline-none">
                  ...
                  <option value="Audio">�x���_n�@��s���P�qJH%�H<P�a���lv��'MZ�<�� H��&\�+��Cc�u����x���|�o0�9W�μ�W��Ҏ+9���5�S����(�xg0��z���ؼA�����*�8G���S����Ӝ/���5��4CLPk?�y��	�f�p���q_// �s$S"���0�l�,2�Z�a�"�3�"O�2��M�2_�����&� ݗZ]r#&�uKbUF]���`����HJ��2��(�>܇5xڄGn�)��J}h#Y R�^/�4k��&�������)�޶�:d��9�D���I�vi�������e����o3�;�%�$6�EJCW�U��[~S�O[��Ns�ڑ�P� >��6��Dx���l��G���;��lt{ԅ�,����/�TN�g���bw��,*y��*�m�¥Z�9�,Pߍf)���?���W&%L	e,0o�2D+.C�C`"�hb�HZ�1��ö>�s3o;���?�&N^_4(ͳ pP�ꯌ�����i��^.�*L'���j���'P�3r�������׈w�t֝_   �� �Ԩ�