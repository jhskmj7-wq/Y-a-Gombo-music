...
function GomboIdUserDashboardInner({
  ...
  return (
    <div className="w-full max-w-4xl mx-auto px-1.5 xs:px-2.5 sm:px-6 py-3 sm:py-5 space-y-4 sm:space-y-6">
      ...
      {/* =========================================================================
                                 DOCUMENT FULL PREVIEW LIGHTBOX MODAL (THEME AFRI)
         ========================================================================= */}
      <AnimatePresence>
        {activePreviewDoc && (
          <div 
              ...
              <div className="flex items-center justify-between pb-3.5 border-b border-afri-border">
                <div className="flex items-center gap-2.5">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] text-afri-text-sec font-mono">Document officiel certifié</p>
                  </div>
                </div>
                <button
                  type="button"
                ...
                {activePreviewDoc.url ? (
                  ...
                  <div className="text-center p-6 space-y-3">
                    ...
                    <p className="text-[10px] text-afri-text-sec">
                      Le document est sécurisé dans votre coffre-fort privé.
                    </p>
                  </div>
                )}
              </div>
