  ...
  useEffect(() => {
    const fetchTalents = async () => {
      ...
      try {
        ...
        // Let's seed a couple of interesting looking mock musicians if there are few
        if (musicians.length <= 2) {
          const seededMusicians: UserProfile[] = [
            {
              uid: "mus1",
              email: "yoro@gombo.ci",
              firstName: "Yorobo",
              ...
              bio: "Guitariste soliste lead d'Abidjan. 6 ans de scène avec de grands artistes de coupé-décalé. Disponible pour concerts, cabarets, mariages rumba et soirées VIP.",
              role: "musicien",
              specialty: "Guitariste",
              specialties: ["Guitariste"],
              experience: "Professionnel",
              musicGenre: "Rumba Congolaise",
              musicGenres: ["Rumba Congolaise", "Coupé-Décalé"],
              ...
              badges: ["⭐ Talent Certifié", "🔥 Artiste Actif"],
              isAvailableNow: true,
            ...
            },
            {
              ...
              bio: "Chanteuse lead lead gospel et acoustique. Voix puissante d'Afrique de l'Ouest. Idéal pour cocktail de mariage chic, louanges chrétiennes et cabaret.",
              role: "musicien",
              specialty: "Chanteur",
              specialties: ["Chanteur", "Choriste"],
              experience: "Légende de la Scène",
              musicGenre: "Gospel",
              musicGenres: ["Gospel", "Acoustique"],
              ...
              badges: ["✅ Profil Vérifié", "🏆 Top Talent"],
              isAvailableNow: true,
              availabilityStatus: "disponible",
              gigsCompleted: 26,
              applicationsSent: 42,
            ...
            {
              uid: "mus3",
              email: "marius@gombo.ci",
              firstName: "Marius",
              lastName: "Goli",
              artistName: "Marius Bébé Sax",
              commune: "Marcory",
              phone: "+225 07 88 55 44 22",
              bio: "Saxophoniste passionné. Diplômé de l'INSAAC. Prestations exceptionnelles pour soirées privées, dîners d'entreprises et lounge de prestige.",
              role: "musicien",
              specialty: "Saxophoniste",
              specialties: ["Saxophoniste"],
              experience: "Professionnel",
              musicGenre: "Jazz / Soul",
              musicGenres: ["Jazz / Soul", "Variété"],
              paymentNumber: "0788554422",
            ...
            {
              uid: "mus4",
              email: "serge_piano@gombo.ci",
              firstName: "Serge",
              lastName: "Yao",
              artistName: "Sergelo Clavier",
              commune: "Cocody",
              phone: "+225 01 22 33 44 55",
              bio: "Pianiste / arrangeur pro. Maîtrise piano acoustique, basse synthé et variété de styles. Accompagnateur d'orchestres de premier plan à Yamoussoukro.",
              role: "musicien",
              specialty: "Pianiste",
              specialties: ["Pianiste"],
              experience: "Professionnel",
              musicGenre: "Variété",
              musicGenres: ["Variété", "Zouglou"],
              paymentNumber: "0122334455",
              paymentProvider: "Wave",
              avatarUrl: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&q=80&w=200",
              isVerified: true,
              verificationStatus: "certifie",
              badges: ["⭐ Talent Certifié"],
              isAvailableNow: true,
              availabilityStatus: "disponible",
              gigsCompleted: 5,
              applicationsSent: 9,
            ...
            {
              uid: "mus5",
              email: "batteur_herve@gombo.ci",
              firstName: "Hervé",
              lastName: "Koffi",
              artistName: "Hervé Baguette Pro",
              commune: "Yopougon",
              phone: "+225 05 99 11 22 33",
              bio: "Batteur énergique et très précis d'Abidjan. Spécialisé Zouglou, Rumba et Afrobeat. Dispose de sa propre batterie complète et d'un véhicule.",
              role: "musicien",
              specialty: "Batteur",
              specialties: ["Batteur"],
              experience: "Professionnel",
              musicGenre: "Zouglou",
              musicGenres: ["Zouglou", "Afrobeat"],
              paymentNumber: "0599112233",
              paymentProvider: "Wave",
              avatarUrl: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&q=80&w=200",
              isVerified: false,
              verificationStatus: "standard",
              badges: ["🔥 Artiste Actif"],
              isAvailableNow: true,
              availabilityStatus: "disponible",
              gigsCompleted: 11,
              applicationsSent: 34,
