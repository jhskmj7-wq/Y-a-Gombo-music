...
export const AvatarItemsTable: React.FC<AvatarItemsTableProps> = ({ items, onEdit }) => {
  ...
  return (
    <div className="w-full overflow-x-auto scrollbar-none rounded-2xl border border-zinc-800 bg-zinc-950">
            ...
            <tr key={item.id} className="hover:bg-zinc-900/50 transition-colors">
              <td className="p-3 flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-[10px] text-zinc-500 truncate max-w-[200px]">{item.description}</div>
                </div>
              </td>
              <td className="p-3 font-mono text-zinc-400 capitalize">{item.category}</td>
              <td className="p-3 font-mono font-bold text-amber-400">{item.price} 🪙</td>
              <td className="p-3 font-mono">
                <span className="px-2 py-0.5 bg-zinc-900 border border-zinc-800 text-[#D4AF37] rounded-md text-[10px]">
                  {item.rarity || 'Commun'}
                </span>
              </td>
              <td className="p-3">
              ...
              <td className="p-3 text-right space-x-1.5 whitespace-nowrap">
                <button 
                  onClick={() => onEdit(item)}
                  className="p-2 rounded-lg bg-zinc-900 hover:bg-zinc-800 text-amber-400 min-h-[36px] min-w-[36px] inline-flex items-center justify-center"
                  title="Modifier"
                >
                ...
                <button 
                  ...
                  className="p-2 rounded-lg bg-zinc-900 hover:bg-zinc-800 text-zinc-400 min-h-[36px] min-w-[36px] inline-flex items-center justify-center"
                ...
                <button 
                  ...
                  className="p-2 rounded-lg bg-zinc-900 hover:bg-zinc-800 text-red-400 min-h-[36px] min-w-[36px] inline-flex items-center justify-center"
                  title="Supprimer"
                >
