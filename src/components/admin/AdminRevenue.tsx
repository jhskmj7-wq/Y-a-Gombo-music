  ...
  return (
    <div className="space-y-6 text-left pb-24 animate-fadeIn">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="p-5 rounded-2xl bg-gradient-to-br from-[#070707] to-black border border-zinc-900 flex justify-between items-center">
          <div>
            <span className="text-[10px] font-mono text-zinc-500 uppercase tracking-widest font-bold">Commissions totales perçues</span>
            <strong className="text-2xl font-display font-black text-white block mt-2">
        ...
        <div className="p-5 rounded-2xl bg-gradient-to-br from-[#070707] to-black border border-zinc-900 flex justify-between items-center">
          <div>
            <span className="text-[10px] font-mono text-zinc-500 uppercase tracking-widest font-bold">Taux de commission de caisse</span>
        ...
        <div className="space-y-3">
          {transactions.length === 0 ? (
            ...
            transactions.map((tx) => (
              <div
                key={tx.id}
                className="p-4 bg-gradient-to-r from-zinc-950 to-black border border-zinc-900 rounded-xl flex justify-between items-center gap-4 hover:border-zinc-800 transition-all text-xs"
              >
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h5 className="font-sans font-bold text-white uppercase">{tx.description}</h5>
                ...
                <div className="text-right">
                  ...
                  <span className="text-[9px] font-mono text-zinc-500 block uppercase font-bold mt-0.5">
