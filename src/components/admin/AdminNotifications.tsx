...
export default function AdminNotifications({ adminEmail = "Fondateur" }: AdminNotificationsProps) {
  ...
  return (
    <div className="min-h-screen bg-[#020202] text-left pb-24 overflow-x-hidden relative">
      {/* IMPERIAL OVERLAY */}
      ...
      <div className="max-w-7xl mx-auto px-4 pt-12 relative z-10 space-y-12">
        ...
        >
          <div className="inline-flex flex-col items-center gap-4">
            ...
            <div>
              <h2 className="text-4xl font-black text-white tracking-tighter uppercase mb-2">Centre de Notifications Impérial</h2>
          ...
          <div className="flex justify-center">
            <button
              ...
              className="px-10 py-4 bg-[#D4AF37] text-black font-black text-xs uppercase rounded-full hover:scale-105 transition-all flex items-center gap-3 shadow-[0_10px_30px_rgba(212,175,55,0.3)]"
            >
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          {[
            ...
            <motion.div
              ...
              className="p-6 bg-zinc-950 border border-zinc-900 rounded-3xl group hover:border-[#D4AF37]/30 transition-all"
            >
              <div className="flex items-center gap-4 mb-4">
                <div className={`w-10 h-10 rounded-2xl bg-black border border-zinc-800 flex items-center justify-center ${stat.color} group-hover:scale-110 transition-transform`}>
        ...
        <AnimatePresence>
          {showForm && (
            ...
            >
              <div className="p-8 bg-zinc-950 border border-[#D4AF37]/30 rounded-3xl relative shadow-[0_30px_60px_rgba(0,0,0,0.5)]">
                ...
                <form onSubmit={handleSubmit} className="space-y-8 relative z-10">
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div className="md:col-span-2 space-y-6">
                      <div className="space-y-2">
                        <label className="text-[10px] font-mono uppercase tracking-widest text-zinc-500 block font-black">Titre du Décret</label>
                        <input
                          type="text"
                          value={title}
                          onChange={(e) => setTitle(e.target.value)}
                          placeholder="EX: ÉVÉNEMENT HISTORIQUE À ABIDJAN"
                          className="w-full bg-black border border-zinc-800 rounded-2xl p-4 text-sm text-white focus:border-[#D4AF37] outline-none transition-all font-black uppercase tracking-tight"
                          required
                        />
                      </div>

                      <div className="space-y-2">
                        <label className="text-[10px] font-mono uppercase tracking-widest text-zinc-500 block font-black">Message Impérial</label>
                        <textarea
                          value={message}
                          onChange={(e) => setMessage(e.target.value)}
                          placeholder="Détaillez la volonté du Fondateur..."
                          rows={6}
                          className="w-full bg-black border border-zinc-800 rounded-2xl p-6 text-sm font-sans text-white focus:border-[#D4AF37] outline-none transition-all resize-none leading-relaxed"
                          required
                        />
                      </div>
                    </div>
                    ...
                    <div className="space-y-6">
                      <div className="space-y-2">
                        <label className="text-[10px] font-mono uppercase tracking-widest text-zinc-500 block font-black">Type & Audience</label>
                        <div className="grid grid-cols-1 gap-3">
                          <select
                            value={type}
                            onChange={(e) => setType(e.target.value as NotificationType)}
                            className="w-full bg-black border border-zinc-800 rounded-xl p-4 text-xs text-white focus:border-[#D4AF37] outline-none appearance-none"
                          >
                      ...
                      <div className="space-y-2">
                        <label className="text-[10px] font-mono uppercase tracking-widest text-zinc-500 block font-black">Programmation (Optionnel)</label>
                        <div className="grid grid-cols-2 gap-3">
                          <input
                            type="date"
                            value={scheduledAtDate}
                            onChange={(e) => setScheduledAtDate(e.target.value)}
                            className="w-full bg-black border border-zinc-800 rounded-xl p-3 text-xs text-white focus:border-[#D4AF37] outline-none"
                          />
                          <input
                            type="time"
                      ...
                      <div className="p-4 bg-black border border-zinc-900 rounded-2xl space-y-4">
                        <div className="flex justify-between items-center">
                          <span className="text-[10px] font-mono text-zinc-500 uppercase font-black">Priorité</span>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-6 border-t border-zinc-900">
                    <div className="space-y-2">
                      <label className="text-[10px] font-mono uppercase tracking-widest text-zinc-500 block font-black flex items-center gap-2">
                  ...
                  <div className="flex flex-col md:flex-row justify-between items-center gap-6 pt-4">
                    ...
                    <div className="flex gap-4">
                      <button
                        type="button"
                        onClick={resetForm}
                        className="px-8 py-4 text-zinc-500 hover:text-white text-[10px] font-black uppercase transition-all"
                      >
                        Annuler
                      </button>
                      <button
                        ...
                        className="px-12 py-4 bg-[#D4AF37] disabled:bg-zinc-800 text-black font-black text-xs uppercase rounded-full flex items-center gap-3 hover:scale-105 active:scale-95 transition-all shadow-[0_10px_40px_rgba(212,175,55,0.2)]"
                      >
        ...
        <div className="space-y-8">
          ...
          <div className="grid grid-cols-1 gap-6">
            {notifications.length === 0 ? (
              <div className="p-20 text-center bg-zinc-950 border border-zinc-900 rounded-3xl">
                <Bell className="w-12 h-12 text-zinc-900 mx-auto mb-4" />
                <p className="text-zinc-500 font-mono text-[10px] uppercase tracking-widest">Le registre impérial est vide.</p>
              </div>
            ) : (
              notifications.map((notif, idx) => {
                ...
                return (
                  <motion.div
                    ...
                    className={`p-6 bg-zinc-950 border rounded-3xl flex flex-col lg:flex-row gap-8 transition-all hover:border-[#D4AF37]/40 relative overflow-hidden group ${
                      isInactive ? "border-zinc-900 grayscale opacity-60" : 
                      notif.priority > 7 ? "border-red-900/50" : "border-zinc-900"
                    }`}
                  >
                    {/* PRIORITY GLOW */}
                    {notif.priority > 7 && (
                    ...
                    <div className="flex items-start gap-6 lg:w-3/4">
                      <div className={`w-16 h-16 rounded-2xl bg-black border border-zinc-800 flex items-center justify-center shrink-0 ${typeInfo.color} shadow-lg`}>
                        <Icon className="w-8 h-8" />
                      </div>
                      
                      <div className="space-y-4">
                        <div className="flex flex-wrap items-center gap-3">
                          <h5 className="text-lg font-black text-white uppercase tracking-tight">{notif.title}</h5>
                          <div className="flex gap-2">
                            ...
                            <span className="px-3 py-1 bg-zinc-900 text-zinc-400 border border-zinc-800 rounded-full text-[8px] font-black uppercase tracking-widest">
                              Priorité {notif.priority}
                            </span>
                          </div>
                        </div>

                        <p className="text-sm text-zinc-400 font-sans leading-relaxed line-clamp-3">
                          {notif.message}
                        </p>

                        <div className="flex flex-wrap gap-4 items-center">
                          <div className="flex items-center gap-1.5 text-[9px] font-mono text-zinc-500 uppercase font-black">
                    ...
                    <div className="lg:w-1/4 border-t lg:border-t-0 lg:border-l border-zinc-900 pt-6 lg:pt-0 lg:pl-8 flex flex-col justify-between">
                      <div className="grid grid-cols-2 gap-4 mb-6">
                        <div className="space-y-1">
                          <div className="text-[8px] font-mono text-zinc-600 uppercase font-black flex items-center gap-1">
                            <Eye className="w-3 h-3" /> Vues
                          </div>
                          <div className="text-xl font-black text-white">{notif.readCount || 0}</div>
                        </div>
                        <div className="space-y-1">
                          <div className="text-[8px] font-mono text-zinc-600 uppercase font-black flex items-center gap-1">
                      ...
                      <div className="flex items-center gap-2">
                        <button
                          ...
                          className="flex-1 h-10 bg-zinc-900 hover:bg-zinc-800 border border-zinc-800 text-white rounded-xl transition-all flex items-center justify-center gap-2 group/btn"
                        >
                        ...
                        <button
                          ...
                          className="w-10 h-10 bg-red-950/20 hover:bg-red-500 border border-red-950/30 text-red-400 hover:text-white rounded-xl transition-all flex items-center justify-center"
                        >
