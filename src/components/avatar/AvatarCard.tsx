...
export const AvatarCard: React.FC<AvatarCardProps> = ({ item, isOwned, isEquipped, onAction, actionLabel }) => {
  return (
    <div className={`bg-afri-bg-sec border rounded-2xl p-3 flex flex-col justify-between space-y-3 w-full max-w-full box-border shadow-md transition-all ${
      ...
      <div className="space-y-1">
        ...
        <p className="text-[10px] text-afri-text-sec line-clamp-1">{item.description || item.category}</p>
      </div>
