      ...
      try {
        ...
        const syncCombinedPosts = () => {
          ...
          const mappedPosts: Post[] = publicList.map((social) => ({
            ...
            thumbnailUrl: social.thumbnailUrl || social.thumbnail || social.coverUrl || social.poster,
            thumbnail: social.thumbnail || social.thumbnailUrl || social.coverUrl || social.poster,
            coverUrl: social.coverUrl || social.thumbnailUrl || social.thumbnail,
            poster: social.poster || social.thumbnailUrl || social.coverUrl,
