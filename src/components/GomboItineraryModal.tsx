  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md">
      <motion.div
        ...
        className="w-full max-w-lg bg-zinc-950 border border-[#D4AF37]/30 rounded-3xl overflow-hidden shadow-2xl text-white relative"
      >
        {/* Header */}
        <div className="p-5 bg-gradient-to-r from-amber-500/10 via-zinc-900 to-zinc-950 border-b border-zinc-800 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-zinc-400 font-mono">Itinéraire souverain AFRIGOMBO</p>
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div className="p-3.5 bg-zinc-900 border border-[#D4AF37]/30 rounded-2xl space-y-1">
              ...
              <p className="text-xs font-bold text-white truncate">{targetTitle}</p>
              <p className="text-[10px] text-zinc-400 font-mono">📍 {targetCommune}</p>
            </div>
          </div>
          ...
          <div className="p-4 bg-gradient-to-r from-zinc-900 via-amber-950/20 to-zinc-900 border border-[#D4AF37]/20 rounded-2xl flex items-center justify-around text-center">
            <div>
              <span className="text-[10px] text-zinc-400 uppercase font-mono block">Distance</span>
              <strong className="text-lg font-black text-[#D4AF37]">{distanceKm} km</strong>
            </div>
            <div className="h-8 w-px bg-zinc-800" />
            <div>
              <span className="text-[10px] text-zinc-400 uppercase font-mono block">Temps Estimé</span>
          ...
          <div className="relative h-48 rounded-2xl bg-zinc-900 border border-zinc-800 overflow-hidden flex flex-col justify-between p-4 shadow-inner">
            ...
            {/* Marker A (User) */}
            <div className="relative z-10 flex items-center gap-2 bg-zinc-950/90 border border-emerald-500/40 p-2 rounded-xl w-fit shadow-md">
              <div className="w-3 h-3 rounded-full bg-emerald-500 animate-ping shrink-0" />
              <span className="text-[11px] font-mono font-bold text-emerald-300">Moi (Départ)</span>
            </div>

            {/* Marker B (Gombo Venue) */}
            <div className="relative z-10 self-end flex items-center gap-2 bg-zinc-950/90 border border-[#D4AF37]/50 p-2 rounded-xl w-fit shadow-md">
